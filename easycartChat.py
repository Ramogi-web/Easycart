...
df = pd.read_csv("easycart_data.csv")
# print(df)

print("Easybot: Hello there, I am your easycart assistance bot. Ask me about any inquiries.")
...
while True:
    ...
    if user_text == "quit":
        print("Easybot: Goodbye! Nice to have been of service to you. Shop easy.")
        break
    ...
    if not found_answer:
        print("Easybot: Sorry, i don't know that one, Try asking for something else.")
